...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { description: @dog.description, name: @dog.name, picture: @dog.picture, rating: @dog.rating }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { description: @dog.description, name: @dog.name, picture: @dog.picture, rating: @dog.rating }
    assert_redirected_to dog_path(assigns(:dog))
  end
